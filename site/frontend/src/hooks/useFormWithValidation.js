...
export default function useFormWithValidation(formType = 'volunteer') {
    ...
    const validateUpdateVolunteerField = (name, value) => {
        switch (name) {
            case 'surname':
            case 'name':
            case 'patronymic':
    ...
    const validateUpdateOrganizationField = (name, value) => {
        switch (name) {
            case 'name':
                return validateLegalName(value);
            case 'email':
    ...
    const checkFormValidity = (values, errors, type) => {
        ...
        } else if (type === 'organizationUpdate') {
            return (
                values.name && !errors.name &&
                values.email && !errors.email &&
                values.phone && !errors.phone &&
