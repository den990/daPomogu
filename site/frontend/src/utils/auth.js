...
export function registerVolunteer(email, phone, name, surname, patronymic, date_of_birthday, registration_address, password) {
  return fetch(`${BASE_URL}/register`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
    body: JSON.stringify({ email, phone, name, surname, patronymic, date_of_birthday, registration_address, password })
  })
