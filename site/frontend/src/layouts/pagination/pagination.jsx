            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                <div className="flex gap-2">
                    <button
                        ...
                        className={`px-3 py-1 border border-gray-200 rounded-md ${(numberOfPageOut - 1 == 0) ? "bg-gray-200" : "hover:bg-gray-50"}`}
                    ...
                    {Array.from({ length: countOfPages }, (_, i) => (
                        <button
                            ...
                            key={i} className={`px-3 py-1 ${(i + 1 == numberOfPageOut) ? "bg-red-600 text-white" : "border border-gray-200 hover:bg-gray-50"} rounded-md`}
                        >
                            {i + 1}
                        </button>
                    ))}
                    <button 
                        onClick={() => handlePageChange(numberOfPageOut + 1)}
                        className={`px-3 py-1 border border-gray-200 rounded-md ${(numberOfPageOut == countOfPages) ? "bg-gray-200 disabled" : "hover:bg-gray-50"}`}
