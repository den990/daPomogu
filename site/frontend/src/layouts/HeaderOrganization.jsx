        ...
        <header className="bg-white shadow-sm py-3 px-4">
            <div className="container mx-auto flex items-center justify-between">
                <div className="flex items-center space-x-2">
                    ...
                    <Link to={ROUTES.HOME} className="text-lg md:text-xl font-bold text-red-600">
                        ДаПомогу
                    </Link>
                </div>

                <nav className="hidden lg:flex lg:items-center lg:space-x-4 lg:space-x-6">
                    <Link to={ROUTES.TASKS_CATALOG} className="text-gray-600 hover:text-red-600">
                        Задания
                    </Link>
                    <Link to={ROUTES.ORGANIZATION_TASKS} className="text-gray-600 hover:text-red-600">
                        Мои задания
                    </Link>
                    <Link
                ...
                <div className="flex items-center space-x-2 md:space-x-4">
                    <Link
                        ...
                        className="w-10 h-10 flex items-center justify-center bg-red-600 text-white rounded-full hover:bg-red-700 md:w-auto md:px-4 md:py-2 rounded-lg md:flex md:items-center"
                    >
                    ...
                    <div className="relative flex items-center" ref={menuRef}>
                        <button
                            ...
                            className="px-2 py-1 md:px-4 md:py-2 hover:bg-gray-50 rounded-md"
                        >
                            <div className="flex items-center">
                                <img
                                    ...
                                    alt="Organization"
                                />
                                <span className="hidden md:inline-block px-2 lg:px-3">
                        ...
                        {isOpen && (
                            <div className="absolute right-0 mt-2 w-40 bg-white text-black rounded-md shadow-lg z-50">
                                ...
                                <button onClick={logout} className="block w-full text-left px-4 py-2 hover:bg-gray-50">
                                    Выйти
                                </button>
                            </div>
                        )}
