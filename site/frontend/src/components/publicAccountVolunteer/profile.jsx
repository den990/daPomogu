    ...
    return (
        <div id="profile-section" className="md:col-span-1">
            ...
            <div className="flex flex-col items-center">
                ...
                <h2 className="mt-4 text-xl font-semibold">{profile ? `${profile.name} ${profile.surname}` : "Нет данных"}</h2>
            ...
            <div className="mt-6 gap-4 text-center flex flex-col justify-center">
                ...
                <Link to={ROUTES.CHAT} className="w-full mt-4 bg-red-600 text-white py-2 rounded-lg hover:bg-red-700">
                    Написать сообщение
                </Link>
            </div>
            </div>
