    ...
    return (
        <div className="col-span-2">
            <div className="grid grid-cols-1 place-items-center">
                <div id="task-banner" className="w-[500px] h-[300px] bg-neutral-300 rounded-lg mb-6 flex items-center justify-center">
            ...
            <div id="task-header" className="mb-8">
                ...
                <div className="flex items-center gap-4 mb-4">
                    <div className="flex items-center gap-2">
                        <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&amp;seed=456" className="w-10 h-10 rounded-full" alt="organization" />
                        <span className="text-neutral-900 hover:underline cursor-pointer">Благотворительный фонд "Надежда"</span>
                    </div>
                    <span className="text-neutral-500">•</span>
                    <span className="text-neutral-600">15 марта 2025 14:00</span>
                </div>
            </div>
                ...
                <div className="space-y-4 mb-4">
                    <div className="bg-white p-4 rounded-lg border">
                        <div className="flex items-center gap-3 mb-2">
                            <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&amp;seed=789" className="w-8 h-8 rounded-full" alt="person" />
                            <div>
