    ...
    return (
        <main id="main-content" className="container mx-auto px-4 pt-20 pb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <p className="text-neutral-600">
                            Требования к отчету: минимум 3 фотографии, показывающие процесс работы
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section id="action-buttons" className="flex flex-col md:flex-row gap-4 justify-end">
                <button className="px-4 py-2 bg-neutral-200 rounded-lg hover:bg-neutral-300">Очистить форму</button>
                <button className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">Отправить отчет</button>
            </section>
        </main>
    );
}
