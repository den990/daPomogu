            ...
            <div className="container mx-auto px-4 h-full flex items-center">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="hidden md:block">
                        <img style={{ maxWidth: 600 }} className="w-full h-auto rounded-lg shadow-xl" src="https://storage.googleapis.com/uxpilot-auth.appspot.com/78e1578dcd-f9d3012551e8cf37535a.png" alt="illustration of diverse group of volunteers helping community, modern minimal style, red and white color scheme" />
                    </div>
                </div>
            </div>
        </section>
