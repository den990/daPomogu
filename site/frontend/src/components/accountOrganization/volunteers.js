        ...
        <section id="volunteers" className="bg-white rounded-lg shadow-sm p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div id="volunteer-1" className="flex items-center space-x-4 border border-gray-200 rounded-lg p-4">
                    <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-1.jpg" className="w-12 h-12 rounded-full" alt="volunteer" />
                    <div>
                ...
                <div id="volunteer-2" className="flex items-center space-x-4 border border-gray-200 rounded-lg p-4">
                    <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-2.jpg" className="w-12 h-12 rounded-full" alt="volunteer" />
                    <div>
