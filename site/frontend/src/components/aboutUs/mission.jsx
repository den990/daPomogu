            ...
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-3xl mx-auto text-center">
                    <p className="text-lg text-gray-600 mb-8">
                        Мы стремимся объединить волонтеров и организации, создавая эффективную платформу для совместной
                        работы и помощи обществу. Наша цель - сделать волонтерство доступным и организованным для всех.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                        ...
                        >
                            <img
                                style={{ width: 30, height: 30 }}
                                src={require("../../images/members.svg").default}
                                alt="members"
                            />
