        ...
        >
          ...
          <nav className="mt-4">
             <Link to={ROUTES.ADMIN_PANEL} className="flex items-center gap-3 px-4 py-3 md:px-6 text-gray-700 hover:bg-gray-50 rounded-lg mb-1">
              ...
              <Link to={ROUTES.ADMIN_DASHBOARD} className="flex items-center gap-3 px-4 py-3 md:px-6 text-gray-700 hover:bg-gray-50 rounded-lg mb-1">
                  <img className="w-5 h-4" src={require("../../images/people_dark.svg").default} alt="people" />
                  <span className="ml-3 text-sm md:text-base">Пользователи</span>
              </Link>
              <Link to="/#" className="flex items-center gap-3 px-4 py-3 md:px-6 text-gray-700 hover:bg-gray-50 rounded-lg mb-1">
              ...
              <Link to={ROUTES.ADMIN_REGISTER_ORGANIZATION} className="flex items-center gap-3 px-4 py-3 md:px-6 text-red-600  bg-red-50  rounded-lg">
