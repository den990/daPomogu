...
function RegistrationForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        const {email, phone, inn, name, legal_address, actual_address, full_name_owner} = values;
        
        try {
            await registerOrganization(email, phone, inn, name, legal_address, actual_address, full_name_owner)
            ...
            <div className="max-w-md mx-auto">
                ...
                <form id="registration-form" className="space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        ...
                        {errors.full_name_owner && <span className="text-red-600 text-xs">{errors.full_name_owner}</span>}
                    </div>
                    <div>
