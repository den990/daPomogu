    ...
    return (
        <div id="sidebar" className="fixed h-full w-64 bg-white border-r border-gray-200 pt-6">
            ...
            <nav className="px-4">
                ...
                <Link to={ROUTES.ADMIN_DASHBOARD} className="flex items-center gap-3 px-4 py-3 text-red-600 bg-red-50 rounded-lg mb-1">
                    <img style={{width: 20, height: 16}} src={require("../../images/people_red.svg").default} alt="people" />
